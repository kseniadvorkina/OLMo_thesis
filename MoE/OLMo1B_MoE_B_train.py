...
def collate_fn(batch):
    ...
    # Explicitly cast input_ids back to LongTensor
...
optimizer = torch.optim.AdamW(moe_model.gate.parameters(), lr=1e-4)
epochs = 3
...
for epoch in range(epochs):
    ...
    torch.save(moe_model.gate.state_dict(), f"./moe_gate_3epochs_B_epoch{epoch+1}.pt")
