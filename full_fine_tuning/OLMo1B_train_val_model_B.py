...
def prepare_chunks(text, max_context_size=2048):
    # Reserve space for the eos_token
    max_chunk_size = max_context_size - 1
...
def prepare_encodings(df_subset):
    ...
    for _, row in df_subset.iterrows():
        ...
        encodings.extend(prepare_chunks(text))
    return encodings
...
model.save_pretrained("./fine_tuned_model_B")
tokenizer.save_pretrained("./fine_tuned_model_B")
